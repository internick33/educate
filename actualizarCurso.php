        ...
        <main role="main">
          ...
          <div class="jumbotron " style="margin-top:100px;">
            <div class="container" >
              ...
              <p class="text-center">Actualizar Cursos.</p>
            </div>
          </div>
    
          <div class="container">
              <div class="col-md-6 offset-md-3">
              <h2 class="text-center text-primary">Actualizar Curso</h2>
              ...
              <?php
                ...
                ?>    
                    ...
                    <div class="form-group">
                        <label>Clave</label>
                        <input type="text" class="form-control" name="clave" placeholder="Escribe la clave del curso" required value=<?php echo $fila['clave'] ?>>
                    </div>

                    <div class="form-group">
                      <label>Nombre</label>
                      <input type="text" class="form-control" name="nombre" placeholder="Escribe el nombre del curso" required value=<?php echo $fila['nombre'] ?>>
                    </div>
