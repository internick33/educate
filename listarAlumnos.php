...
<body class="container">
        ...
        ">
          ...
          <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            ...
            <ul class="navbar-nav mr-auto">
              <li>
                <form action="resultadosAlumnos.php" method="POST" class="form-inline">
                  <span class="text-white"> Tipo de Busqueda: &nbsp;</span>
                  <div class="form-group">
                    <select name="tipobusqueda" class="custom-select">
                      <option value="nombre">Nombre
                      <option value="APaterno">Apellido Paterno
                      <option value="AMaterno">Apellido Materno  
                    </select>
                  </div>
                  &nbsp;&nbsp;&nbsp;
        ...
        <main role="main">
          ...
          <div class="jumbotron " style="margin-top:100px;">
            <div class="container" >
              ...
              <p class="text-center">Administracion de Alumnos.</p>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-md-8 offset-md-2">
                ...
                <table class="table table-dark table-striped table-hover">
                      ...
                      <?php
                          $repetir = $con->query("SELECT * FROM alumno");
                      ...
                      ?>    
                          <tr>
                              ...
                              <td>
                                <a href="eliminarUsuario.php?id= <?php echo $fila['usuario_id'] ?>" >
                                  <i class="fa fa-trash-o btn-danger p-2" style=" border-radius: 5px 5px 5px 5px;"></i>
                                </a>
                                <a href="actualizarUsuario.php?id= <?php echo $fila['usuario_id'] ?>" >
                                  <i class="fa fa-pencil btn-info p-2" style=" border-radius: 5px 5px 5px 5px;"></i>
                                </a>
                                <a href="detalleUsuario.php?id= <?php echo $fila['usuario_id'] ?>" >
                ...
                <div class="col-md-6 offset-md-3">
                  <a href="insertarUsuario.php" class="btn btn-info"><i class="fa fa-plus"></i>Agregar Alumno</a>
                  <a href="listarAlumnos.php" class="btn btn-outline-success"><i class="fa fa-search-plus"></i>Buscar Alumno</a>
                </div>
              </div>
            </div>
