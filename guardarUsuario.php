...
<head>
    ...
    <?php
        ...
        $insertar = $con->query("INSERT INTO usuario VALUES (NULL,'$nombre', '$password', '$role')");
    ?>
...
<body class="container">
        ...
        <main role="main">
          ...
          <div class="jumbotron cambiarFondo2">
            <div class="container">
              <h1 class="display-3"><b>Usuario guardado con exito</b></h1>
              <a href="listarUsuarios.php" class="btn btn-outline-success offset-md-3 mt-4 ">Volver a la administracion de los usuarios</a>
            </div>
          </div>
