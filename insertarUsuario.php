        ...
        <main role="main">
          ...
          <div class="jumbotron " style="margin-top:100px;">
            <div class="container" >
              ...
              <p class="text-center">Insertar nuevos usuarios.</p>
            </div>
          </div>
          ...
          <div class="container">
              <div class="col-md-6 offset-md-3">
                ...
                <h2 class="text-center text-primary">Insertar nuevo usuario</h2>
              <form action="guardarUsuario.php" method="POST">
                ...
                <div class="form-group">
                    <select name="role" class="custom-select">
                      <option value="ADMIN_ROLE">Usuario Administrador
                      <option value="USER_ROLE">Usuario comun
                    </select>
                </div>
        
                <button type="submit" class="btn btn-block btn-primary">Guardar Usuario</button>
              </form>
